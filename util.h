...
struct Material {
	Material( Colour ambient, Colour diffuse, Colour specular, double exp, double ref_index, double refractive_index ) :
		ambient(ambient), diffuse(diffuse), specular(specular), 
		specular_exp(exp), ref_index(ref_index), refractive_index(refractive_index) {}
	...
	// Specular expoent.
	double specular_exp;
	//reflective index of the material
	double ref_index;
...
struct Intersection {
	...
	bool none;
	//track if intersection is a shadow
	bool shadow;
	//used for refraction
	bool inside;
};
