...
private:
	...
	//depth is used for dissallowing infinte recursion for refraction/reflection
	...
	//maximum depth of the scene. used for recursive calls of shadeRay in order to get specular rays
	int _maxDepth;
};
